...
module load CUDA/11.8.0 cuDNN/8.7.0.84-CUDA-11.8.0
module load Anaconda3/2024.02-1

# Activate conda environment
source /sw/eb/sw/Anaconda3/2024.02-1/etc/profile.d/conda.sh
conda activate /scratch/user/u.hn319322/conda_envs/cvae
...
# Configuration
INPUT_DIR="/ondemand/Downscaling/mydata_corrected"
OUTPUT_DIR="/ondemand/Downscaling/cVAE_augmentation"
